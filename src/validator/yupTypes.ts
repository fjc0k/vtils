...
declare module 'yup/es/util/printValue' {
  function printValue(value: string, quoteStrings: boolean): string
  export = printValue
}

declare module 'yup/es/locale' {
  import { LocaleObject } from 'yup/es'
...
declare module 'yup/es' {
  ...
  export interface SchemaFieldInnerTypeDescription
    extends Pick<
      SchemaDescription,
      Exclude<keyof SchemaDescription, 'fields'>
    > {
