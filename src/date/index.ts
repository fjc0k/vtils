...
export { zhCN, enUS } from 'date-fns/locale'

// @index(['./**/*.ts', '!./**/*.test.*'], f => `export * from '${f.path}'`)
export * from './anyToDate.ts'
export * from './formatDate.ts'
export * from './formatDistanceAgo.ts'
export * from './formatDistancePlus.ts'
export * from './intervalToRestrictiveDuration.ts'
export * from './ms.ts'
export * from './numeralDayToChineseDay.ts'
// @endindex
