 ...
 */
var cssTransform = function (el, transformRule, transitionRule) {
...
function mapValues(obj, callback) {
    var newObj = {};
    forOwn(obj, function (value, key, source) {
...
function supportPassiveEventListener() {
    ...
    if (isSupportPassiveEventListener === undefined) {
        ...
        try {
            ...
            inBrowser(function () {
                window.addEventListener('test', null, options_1);
            });
        }
        catch (err) { }
    }
...
function values(obj) {
    var result = [];
    forOwn(obj, function (value) { return result.push(value); });
    return result;
}

export { Disposer, base64Decode, base64Encode, base64UrlDecode, base64UrlEncode, bindEvent, castArray, clamp, cssTransform, fill, forOwn, getType, has, inBrowser, inWechatMiniProgram, inWechatWebview, isArray, isBoolean, isDate, isEqualArray, isFinite, isFunction, isInteger, isNaN, isNil, isNull, isNumber, isObject, isPlainObject, isRegExp, isString, isUndefined, mapValues, noop, parseCSSValue as parseCssValue, preventEventDefault, reduce, repeat, shuffle, stopEventPropagation, supportPassiveEventListener, values };
